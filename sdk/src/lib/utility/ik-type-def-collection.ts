...
export interface SrcOptions {
    ...
    */
     ...
     * ```
     */
    urlEndpoint?: JSSourceOptions["urlEndpoint"];
     ...
     */
    queryParameters?: JSSourceOptions["queryParameters"]
     ...
     */
    transformation?: JSSourceOptions["transformation"];
...
export type IkImageComponentOptions = SrcOptions & Partial<Pick<GetImageAttributesOptions, "deviceBreakpoints" | "imageBreakpoints">> & {
  /**
...
export interface IkVideoComponentOptions extends SrcOptions {}
